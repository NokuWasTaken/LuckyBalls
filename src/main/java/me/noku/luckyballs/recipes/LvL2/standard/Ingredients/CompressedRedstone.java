...
public class CompressedRedstone {

    private static final NamespacedKey KEY = new NamespacedKey(LuckyBalls.getInstance(), "redstone_compressed");

    private static final ItemStack ITEMSTACK = new ItemBuilder(Material.REDSTONE).setDisplayname(ChatColor.GRAY + "Compressed Redstone").addEnchantement(Enchantment.LUCK, 1, true).addItemFlags(ItemFlag.HIDE_ENCHANTS).addNameSpacedKey(KEY).addCustomModelData(1).build();
